...
function Home(){
    ...
    useEffect(() => {
        ...
        const getRepos = async () => {
            ...
            setAddUpReposCount(data.public_repos);
    ...
    function deleteRepos(){
        ...
        const performOperation = async () => {
            ...
            if (res.status==204) {
                ...
                if (AddUpReposCount >1) {
                    setAddUpReposCount((s) => s-1);
                }else{
                    setAddUpReposCount(0);
                }
